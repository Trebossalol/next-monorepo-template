...
export const VALID_SORT_FIELDS: SortBy[] = [
	'name',
	'status',
	'createdAt',
	'updatedAt'
...
export const searchParams = {
	query: parseAsString.withDefault('').withOptions(queryOptions),
	pageIndex: parseAsInteger.withDefault(0).withOptions(queryOptions),
